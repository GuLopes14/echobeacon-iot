...
const char* ID_MQTT = "esp32_beacon1";  // ID único para Beacon 1
const char* TOPIC_SUBSCRIBE = "fiap/iot/echobeacon/comando";

// ====== Identificação da Moto (BEACON 1) ======
const String PLACA_ESPERADA = "ABC1234";
const String MODELO_ESPERADO = "MOTTU_E";
...
// ====== Funções ======
void initWiFi() {
  Serial.print("🔴 BEACON 1 - Conectando ao Wi-Fi ");
...
void setup() {
  ...
  Serial.println("✅ Sistema EchoBeacon 1 pronto!");
  Serial.println("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n");
}
